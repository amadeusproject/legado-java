...
public class Facade {
	...
	/**
	 * M�todo que insere um usu�rio no sistema Amadeus
	 * @param person Usu�rio a ser cadastrado
	 * @return person Usu�rio j� cadastrado, com seu ID gerado pelo sistema
	 * @throws UserAlreadyExistsException Exce��o levantada quando o usu�rio a ser cadastrado j� existe no sistema
	 */
	...
	/**
	 * M�todo que insere um curso no sistema Amadeus
	 * @param course
	 * @return course j� cadastrado, com seu ID gerado pelo sistema
	...
	/**
	 * M�todo que atualiza um curso no sistema Amadeus
	 * @param course
	 * @return course j� atualizado
	 */
	...
	/**
	 * M�todo que insere uma palavra-chave no sistema amadeus
	 * @param keyword palavra-chave a ser cadastrada
	 * @return keyword palavra-chave j� cadastrada, com seu ID gerado pelo sistema
	 */
	...
	/**
	 * M�todo que remove uma palavra-chave no sistema amadeus
	...
	/**
	 * M�todo que verifica se uma palavra-chave esta cadastrada no sistema amadeus
	 * @param keyword palavra-chave a ser verificada
	 * @return boleano da verifica��o
	 */
